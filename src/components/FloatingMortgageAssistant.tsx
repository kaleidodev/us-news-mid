...
const STORAGE_KEY = "nestwise:assistant-state:v1";
...
function SummaryActions({
  ...
  const [saved, setSaved] = useState(false);
    const handleSave = () => {
      try {
        const key = "nestwise:saved-estimates";
    ...
    >
      ...
      >
        <div className="flex items-center gap-2 leading-none">
          ...
          <span className="font-serif text-[#0f2542] font-black text-[16px]">
            NestWise <span className="font-semibold text-[#0d9488]">AI</span>
          </span>
        </div>
